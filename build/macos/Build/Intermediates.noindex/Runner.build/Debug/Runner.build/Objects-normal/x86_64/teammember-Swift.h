...
#ifndef TEAMMEMBER_SWIFT_H
#define TEAMMEMBER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="teammember",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10teammember11AppDelegate")
...
SWIFT_CLASS("_TtC10teammember17MainFlutterWindow")
